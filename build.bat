...
ar rcs libaes_ige_aead.a %SRC%/sha256.o %SRC%/aes.o %SRC%/gf128.o %SRC%/aes_ige.o %SRC%/poly_mac.o %SRC%/aes_ige_aead.o %SRC%/chacha20.o %SRC%/poly1305.o %SRC%/chacha20_poly1305.o
ranlib libaes_ige_aead.a 2>nul

echo Building test_vectors...
gcc -o test_vectors.exe %SRC%/sha256.o %SRC%/aes.o %SRC%/gf128.o %SRC%/aes_ige.o %SRC%/poly_mac.o %SRC%/aes_ige_aead.o %SRC%/chacha20.o %SRC%/poly1305.o %SRC%/chacha20_poly1305.o tests/test_vectors.c -I%INC%
if %errorlevel% neq 0 exit /b 1

echo Building demo...
gcc -o demo.exe %SRC%/sha256.o %SRC%/aes.o %SRC%/gf128.o %SRC%/aes_ige.o %SRC%/poly_mac.o %SRC%/aes_ige_aead.o %SRC%/chacha20.o %SRC%/poly1305.o %SRC%/chacha20_poly1305.o demo/demo.c -I%INC%
if %errorlevel% neq 0 exit /b 1
